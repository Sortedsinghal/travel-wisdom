...
const tripData = {
  title: 'Jibhi & Tirthan Valley Weekend Trip',
  duration: '3 Days 2 Nights',
  pickupDrop: 'Delhi-Delhi',
  category: 'Weekend Trips',
  pricing: {
    startPrice: '9,000',
    originalPriceQuad: '10,500',
    originalPriceTriple: '10,000',
    originalPriceDouble: '9,500',
    discount: '1,500',
    quad: '9,000',
    triple: '9,500',
    double: '10,000',
  ...
  overview: `<p>Discover the hidden gems of Himachal Pradesh with this serene weekend getaway to Jibhi and Tirthan Valley. Nestled in the Great Himalayan National Park region, these pristine valleys offer untouched natural beauty, crystal-clear rivers, dense forests, and traditional Himachali culture. Experience the tranquility of mountain life, visit the beautiful Jibhi waterfall, trek to Serolsar Lake, and enjoy riverside camping in one of India's most peaceful destinations.</p>`,
  itinerary: [
    { day: "Day 0", title: "Delhi to Jibhi | Overnight Journey", content: "<ul><li>Assemble at boarding point in Delhi and meet your Trip Captain.</li><li>Start overnight journey to Jibhi in comfortable AC bus.</li><li>Enjoy the scenic drive through the mountains.</li></ul>" },
    { day: "Day 1", title: "Jibhi Arrival | Local Exploration", content: "<ul><li>Arrive in Jibhi early morning and check into homestay/hotel.</li><li>Freshen up and have traditional Himachali breakfast.</li><li>Visit the beautiful Jibhi waterfall and surrounding forest.</li><li>Explore the quaint village and interact with locals.</li><li>Evening bonfire and stargazing session.</li><li>Overnight stay in Jibhi homestay.</li></ul>" },
    { day: "Day 2", title: "Serolsar Lake Trek | Tirthan Valley", content: "<ul><li>Early morning trek to Serolsar Lake via Jalori Pass.</li><li>Visit Budhi Nagin Temple at the lake.</li><li>Enjoy packed lunch with panoramic mountain views.</li><li>Drive to Tirthan Valley and check into riverside accommodation.</li><li>Evening riverside walk and trout fishing (optional).</li><li>Overnight stay in Tirthan Valley.</li></ul>" },
    { day: "Day 3", title: "Tirthan Valley to Delhi | Departure", content: "<ul><li>Morning nature walk along Tirthan River.</li><li>Visit Great Himalayan National Park entrance.</li><li>Check out and start return journey to Delhi.</li><li>Overnight journey back to Delhi.</li></ul>" },
    { day: "Day 4", title: "Delhi Arrival", content: "<ul><li>Arrive in Delhi early morning with wonderful memories.</li></ul>" }
  ],
  inclusions: `<ul><li>Transportation: AC Semi-Sleeper bus Delhi to Delhi</li><li>2 Nights accommodation on sharing basis (1 night Jibhi + 1 night Tirthan Valley)</li><li>4 Meals: 2 Breakfasts + 2 Dinners</li><li>All transfers and sightseeing by tempo traveler</li><li>Experienced Trip Captain and local guide</li><li>Serolsar Lake trek with guide</li><li>Driver allowances, toll taxes, parking charges</li></ul>`,
  exclusions: `<ul><li>Any meals not mentioned in inclusions</li><li>Personal expenses and shopping</li><li>Trout fishing charges</li><li>Travel insurance</li><li>Any entry fees not mentioned</li><li>GST (5%) applicable extra</li></ul>`,
  thingsToPack: [
  ...
  reviews: [
      { name: "Priya Sharma", rating: 5, comment: "Absolutely magical experience! Jibhi and Tirthan Valley are hidden gems. The homestay experience and Serolsar Lake trek were highlights of the trip.", image: '/cloned_media/profilepic.png' },
      { name: "Rohit Kumar", rating: 5, comment: "Perfect weekend getaway from Delhi. The natural beauty and peaceful environment were exactly what I needed. Highly recommend for nature lovers.", image: '/cloned_media/24894620230801111526.png' },
      { name: "Sneha Patel", rating: 4, comment: "Beautiful valleys and great organization. The trek to Serolsar Lake was challenging but rewarding. Loved the riverside stay in Tirthan Valley.", image: '/cloned_media/159420230801111701.png' }
  ],
  relatedTrips: [
      ...
      <main className="max-w-screen-xl mx-auto px-4 pt-4 sm:pt-8 pb-20 lg:pb-8">
        <div className="lg:hidden mb-4">
           <div className="overflow-x-auto snap-x snap-mandatory flex gap-2">
                {tripData.mobileGallery.map((img, i) => (
                    <img key={i} src={img} className="snap-center flex-shrink-0 w-full h-64 object-cover rounded-lg shadow-md" alt={`Jibhi Tirthan Valley scenery ${i+1}`} />
                ))}
           </div>
        </div>
        ...
        <header className="hidden lg:block mb-6">
          <div className="flex gap-2 h-[500px]">
            <div className="w-3/5">
              <img src={tripData.mainImageDesktop} className="w-full h-full object-cover rounded-l-2xl shadow-lg" alt="Main Jibhi Tirthan Valley view"/>
            </div>
...
export default JibhiTirthanValley;