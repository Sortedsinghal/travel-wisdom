...
const reasons = [
  ...
  { icon: <UserCheck className="w-10 h-10 text-blue-700" />, title: 'Filtering Like-Minded Travellers', description: 'We make sure to bring only like-minded travellers on basis of age, gender, comfort etc.'}, // Typo fixed here
    ...
    <div className="bg-white">
      ...
      <main className="max-w-[1600px] mx-auto px-6 lg:px-12 py-8">
        ...
        <div className="space-y-20 mt-20">
          <section>
            {/* Added px-6 to align heading with slider padding */}
            <h2 className="text-4xl font-bold mb-6 px-6">Kashmir Honeymoon Trips</h2>
            <TripSlider trips={honeymoonTripsKashmir} slidesToShow={4} />
          </section>
          <section>
            {/* Added px-6 to align heading with slider padding */}
            <h2 className="text-4xl font-bold mb-6 px-6">Kashmir Family Tours</h2>
            <TripSlider trips={familyToursKashmir} slidesToShow={4} />
          </section>
          <section>
            {/* Added px-6 to align heading with slider padding */}
            <h2 className="text-4xl font-bold mb-6 px-6">Jammu & Kashmir Holiday Tours</h2>
            <TripSlider trips={jammuKashmirToursKashmir} slidesToShow={4} />
          </section>
          <section>
            {/* Added px-6 to align heading with slider padding */}
            <h2 className="text-4xl font-bold mb-6 px-6">Best Treks in Kashmir</h2>
              ...
              {reasons.map((reason, index) => (
                <div key={index} className="bg-gray-50 rounded-lg p-8 text-center shadow-sm hover:shadow-xl transition-shadow duration-300">
                  <div className="mb-4 inline-block bg-blue-100 p-4 rounded-full">
                    ...
                    {React.cloneElement(reason.icon, { className: "w-10 h-10 text-blue-700" })}
                  </div>
