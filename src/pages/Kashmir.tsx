    ...
    <div className="bg-white">
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 py-4 sm:py-8">
        ...
        <section className="relative">
          <img src="/cloned_media/34336120240912063512.png" className="w-full h-[300px] sm:h-[400px] lg:h-[500px] object-cover rounded-xl sm:rounded-2xl" alt="Scenic view of Kashmir"/>
        ...
        <section className="mt-8 sm:mt-12 lg:mt-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
            <div className="lg:col-span-8">
              <TripSlider trips={handpickedTripsKashmir} slidesToShow={2} />
            </div>
