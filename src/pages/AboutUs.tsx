...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Video Section */}
      <div className="w-100 position-relative h-[400px] md:h-[600px]">
        <video 
        ...
        >
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto mt-5">
              <p className="font-semibold text-2xl md:text-3xl text-center font-poppins text-yellow-400 mb-2">
                Who We Are?
              </p>
              <p className="font-normal text-sm md:text-base mx-auto font-poppins text-white text-center mt-0 mb-4 max-w-4xl leading-relaxed">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 mt-6 md:mt-8 mb-4 justify-center items-end">
                <div className="flex flex-col items-center h-full">
                  <img src="/who-we-are icon1.png" alt="Trips Hosted" className="w-10 h-10 md:w-12 md:h-12 mb-2 md:mb-3 mt-2 md:mt-3" loading="lazy" decoding="async" />
                  <p className="text-xs md:text-sm text-white font-semibold font-poppins mb-0 mt-1 md:mt-2 text-center">
                    1100+ Trips Hosted PAN India & Abroad
                  </p>
                </div>
                <div className="flex flex-col items-center h-full">
                  <img src="/who-we-are icon2.png" alt="Countries" className="w-10 h-10 md:w-12 md:h-12 mb-2 md:mb-3 mt-2 md:mt-3" loading="lazy" decoding="async" />
                  <p className="text-xs md:text-sm text-white font-semibold font-poppins mb-0 mt-1 md:mt-2 text-center">
                    Proudly operating in 17+ countries
                  </p>
                </div>
                <div className="flex flex-col items-center h-full">
                  <img src="/who-we-are icon3.png" alt="Happy Travelers" className="w-10 h-10 md:w-12 md:h-12 mb-2 md:mb-3 mt-2 md:mt-3" loading="lazy" decoding="async" />
                  <p className="text-xs md:text-sm text-white font-semibold font-poppins mb-0 mt-1 md:mt-2 text-center">
                    17,000+ Happy Travellers
                  </p>
                </div>
                <div className="flex flex-col items-center h-full">
                  <img src="/who-we-are icon4.png" alt="Travel Enthusiasts" className="w-10 h-10 md:w-12 md:h-12 mb-2 md:mb-3 mt-2 md:mt-3" loading="lazy" decoding="async" />
                  <p className="text-xs md:text-sm text-white font-semibold font-poppins mb-0 mt-1 md:mt-2 text-center">
        ...
        <div className="relative bg-gray-50 py-8 md:py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h3 className="font-poppins text-2xl md:text-3xl font-semibold capitalize text-black relative mb-4 text-center">
                Meet the Founder
              </h3>
              <article className="flex flex-col sm:flex-row items-center sm:items-end justify-center mb-6">
                <p className="font-bold text-base md:text-lg inline-block p-1 rounded-lg font-poppins text-white bg-[#0B3A55] mb-2 sm:mb-4 sm:mr-4">
                  Hoor
                </p>
                <p className="mb-2 sm:mb-4 font-semibold text-sm text-black font-poppins">
                  CEO, Founder
                </p>
              </article>
              <p className="font-normal text-sm md:text-base font-poppins text-black leading-relaxed text-center">
              In 2020, Ms. Hoor began her journey of turning her deep love for travel into a meaningful purpose. What started as a simple passion for exploring new places soon transformed into Travel Wisdom, a community-driven platform that brings together people who dream to explore and celebrate life through travel.
              <br /><br />
...
<section className="py-8 md:py-12">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center w-full mb-8 md:mb-12">
            <h2 className="font-poppins text-2xl md:text-3xl font-semibold capitalize text-black text-center">
          ...
          <div className="grid gap-3 md:gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
            {/* Image 1 - spans 2 columns on mobile */}
            <div className="col-span-2 sm:col-span-1">
              <img 
                alt="party" 
                className="rounded-lg w-full h-[200px] md:h-[250px] object-cover" 
                src="/Life1.jpeg"
                loading="lazy"
                decoding="async"
              />
            ...
            {/* Image 5 - spans 1 column on mobile, centered */}
            <div className="col-span-1 sm:col-span-1">
              <img 
                alt="grid_4" 
                className="rounded-lg w-full h-[200px] md:h-[250px] object-cover" 
