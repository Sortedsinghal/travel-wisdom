...
const holidayToursBali = allTrips.filter(trip =>
  ...
  [
    ...
    'bali-backpacking', // Note: Same slug used twice in original data, included here
    'bali-ultimate-7-days', // Note: Same slug used twice in original data, included here
    'bali-malaysia', // Note: Same slug used twice in original data, included here
