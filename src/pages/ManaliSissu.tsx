...
const tripData = {
  title: 'Manali Sissu Weekend Trip',
  ...
  overview: `<p>Experience the breathtaking beauty of Manali and Sissu in this perfect weekend getaway. Journey through the famous Atal Tunnel to reach the stunning Lahaul Valley, where Sissu village offers spectacular mountain views and pristine landscapes. This short but memorable trip combines the charm of Manali's cafes and temples with the raw beauty of Sissu's alpine scenery, making it an ideal escape from city life.</p>`,
  itinerary: [
    { day: "Day 0", title: "Delhi to Manali | Overnight Journey", content: "<ul><li>Assemble at boarding point in Delhi and meet your Trip Captain.</li><li>Start an overnight journey to Manali in a comfortable AC bus.</li><li>Socialize with fellow travelers and get excited for the adventure ahead.</li></ul>" },
    ...
    { day: "Day 3", title: "Departure to Delhi", content: "<ul><li>Check out from hotel after breakfast.</li><li>Last-minute shopping or relaxation time.</li><li>Depart for Delhi in the evening.</li><li>Overnight journey back to Delhi.</li></ul>" },
    { day: "Day 4", title: "Delhi Arrival", content: "<ul><li>Arrive in Delhi early morning with wonderful memories.</li></ul>" }
  ],
  inclusions: `<ul><li>Transportation: AC Semi-Sleeper bus Delhi to Delhi</li><li>2 Nights accommodation in Manali hotel on sharing basis</li><li>4 Meals: 2 Breakfasts + 2 Dinners</li><li>All transfers and sightseeing by tempo traveler</li><li>Experienced Trip Captain</li><li>Driver allowances, toll taxes, parking charges</li></ul>`,
  ...
  thingsToPack: [
    { text: "Comfortable backpack and day bag for excursions", icon: '/cloned_media/5261020250821080750.png' },
  ...
  reviews: [
      { name: "Priya Sharma", rating: 5, comment: "Amazing weekend trip! The Atal Tunnel experience was incredible and Sissu was breathtakingly beautiful. Perfect for a quick getaway from Delhi.", image: '/cloned_media/profilepic.png' },
      { name: "Rohit Kumar", rating: 5, comment: "Well organized trip with great accommodations. The journey through Atal Tunnel to Sissu was the highlight. Highly recommend for weekend travelers.", image: '/cloned_media/24894620230801111526.png' },
      { name: "Sneha Patel", rating: 4, comment: "Beautiful landscapes and good organization. Sissu village is a hidden gem. The trip was short but very fulfilling.", image: '/cloned_media/159420230801111701.png' }
  ],
  relatedTrips: [
      { title: 'Chopta Tungnath', price: '₹6,500', image: '/cloned_media/himachal.webp' },
      { title: 'Kasol Kheerganga', price: '₹8,000', image: '/cloned_media/uttarakhand.webp' },
      { title: 'Mcleodganj Triund', price: '₹7,500', image: '/cloned_media/kashmir.webp' },
      { title: 'Jibhi Tirthan', price: '₹9,000', image: '/cloned_media/bhutan.webp' }
  ]
};
      ...
      <main className="max-w-screen-xl mx-auto px-4 pt-4 sm:pt-8 pb-20 lg:pb-8">
        <div className="lg:hidden mb-4">
           <div className="overflow-x-auto snap-x snap-mandatory flex gap-2">
                {tripData.mobileGallery.map((img, i) => (
                    <img key={i} src={img} className="snap-center flex-shrink-0 w-full h-64 object-cover rounded-lg shadow-md" alt={`Manali Sissu scenery ${i+1}`} />
                ))}
           </div>
        </div>
        ...
        <header className="hidden lg:block mb-6">
          <div className="flex gap-2 h-[500px]">
            <div className="w-3/5">
              <img src={tripData.mainImageDesktop} className="w-full h-full object-cover rounded-l-2xl shadow-lg" alt="Main Manali Sissu view"/>
            </div>
