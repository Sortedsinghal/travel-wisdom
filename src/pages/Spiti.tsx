...
const handpickedTripsSpiti = allTrips.filter(trip =>
  ...
  [
    'winter-spiti', // Note: Also destination 'Himachal'
    'spiti-valley-circuit-trip-with-manali',
    'spiti-valley-circuit-trip', // Note: Also destination 'Himachal'
...
const circuitTripsSpiti = allTrips.filter(trip =>
  trip.destination === 'Spiti' &&
  [
    'winter-spiti', // Note: Also in handpicked & destination 'Himachal'
    'spiti-valley-circuit-trip', // Note: Also in handpicked & destination 'Himachal'
    'spiti-valley-circuit-trip-with-manali', // Note: Also in handpicked
