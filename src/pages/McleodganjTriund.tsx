...
const tripData = {
  title: 'Mcleodganj Triund Trek Weekend Trip',
  duration: '3 Days 2 Nights',
  pickupDrop: 'Delhi-Delhi',
  category: 'Weekend Trips',
  pricing: {
    startPrice: '7,500',
    originalPriceQuad: '9,000',
    originalPriceTriple: '8,500',
    originalPriceDouble: '8,000',
    discount: '1,500',
    quad: '7,500',
    triple: '8,000',
    double: '8,500',
  ...
  overview: `<p>Discover the spiritual heart of Himachal Pradesh with this perfect weekend getaway to Mcleodganj and Triund. Known as "Little Lhasa," Mcleodganj is the residence of the Dalai Lama and offers a unique blend of Tibetan culture and Himalayan beauty. The highlight of the trip is the trek to Triund, one of the most popular treks in Himachal Pradesh, offering stunning 360-degree views of the Dhauladhar range. Experience Tibetan monasteries, local markets, and camping under the stars at Triund.</p>`,
  itinerary: [
    { day: "Day 0", title: "Delhi to Mcleodganj | Overnight Journey", content: "<ul><li>Assemble at boarding point in Delhi and meet your Trip Captain.</li><li>Start overnight journey to Mcleodganj in comfortable AC bus.</li><li>Enjoy the scenic drive through the mountains.</li></ul>" },
    { day: "Day 1", title: "Mcleodganj Arrival | Local Exploration", content: "<ul><li>Arrive in Mcleodganj early morning and check into hotel.</li><li>Freshen up and have breakfast at a local Tibetan cafe.</li><li>Visit Dalai Lama Temple and Tsuglagkhang Complex.</li><li>Explore Mcleodganj market and Bhagsu Nag Temple.</li><li>Visit Bhagsu Waterfall and enjoy the scenic beauty.</li><li>Overnight stay in Mcleodganj.</li></ul>" },
    { day: "Day 2", title: "Triund Trek | Camping Experience", content: "<ul><li>Early morning start for Triund trek from Gallu Devi Temple.</li><li>Trek through dense forests and scenic landscapes (9 km).</li><li>Reach Triund and set up camps with Dhauladhar views.</li><li>Enjoy packed lunch with panoramic mountain views.</li><li>Evening bonfire and stargazing session.</li><li>Overnight camping at Triund.</li></ul>" },
    { day: "Day 3", title: "Triund to Delhi | Departure", content: "<ul><li>Wake up to beautiful sunrise views over Dhauladhar range.</li><li>Trek back to Mcleodganj after breakfast.</li><li>Last-minute shopping and lunch in Mcleodganj.</li><li>Start return journey to Delhi in the evening.</li><li>Overnight journey back to Delhi.</li></ul>" },
    { day: "Day 4", title: "Delhi Arrival", content: "<ul><li>Arrive in Delhi early morning with wonderful memories.</li></ul>" }
  ],
  inclusions: `<ul><li>Transportation: AC Semi-Sleeper bus Delhi to Delhi</li><li>2 Nights accommodation (1 night Mcleodganj + 1 night Triund camping)</li><li>4 Meals: 2 Breakfasts + 2 Dinners</li><li>All transfers and sightseeing by tempo traveler</li><li>Experienced Trek Guide and Trip Captain</li><li>Camping equipment and tents at Triund</li><li>Driver allowances, toll taxes, parking charges</li></ul>`,
  exclusions: `<ul><li>Any meals not mentioned in inclusions</li><li>Personal expenses and shopping</li><li>Temple entry fees</li><li>Travel insurance</li><li>Any entry fees not mentioned</li><li>GST (5%) applicable extra</li></ul>`,
  thingsToPack: [
    { text: "Good quality backpack and day bag for trekking", icon: '/cloned_media/5261020250821080750.png' },
    { text: "Comfortable trekking shoes with good grip", icon: '/cloned_media/7672820250825123523.png' },
  ...
  reviews: [
      { name: "Priya Sharma", rating: 5, comment: "Amazing spiritual and trekking experience! The Triund trek was breathtaking and Mcleodganj's Tibetan culture was fascinating. Perfect weekend getaway.", image: '/cloned_media/profilepic.png' },
      { name: "Rohit Kumar", rating: 5, comment: "Well organized trip with great guides. The sunrise from Triund was spectacular. Loved exploring the Dalai Lama Temple and local markets.", image: '/cloned_media/24894620230801111526.png' },
      { name: "Sneha Patel", rating: 4, comment: "Beautiful trek and cultural experience. The camping at Triund under stars was magical. Great combination of spirituality and adventure.", image: '/cloned_media/159420230801111701.png' }
  ],
  relatedTrips: [
      { title: 'Kasol Kheerganga', price: '₹8,000', image: '/cloned_media/himachal.webp' },
      { title: 'Jibhi Tirthan Valley', price: '₹9,000', image: '/cloned_media/uttarakhand.webp' },
      { title: 'Chopta Tungnath', price: '₹6,500', image: '/cloned_media/kashmir.webp' },
      { title: 'Himachal Backpacking', price: '₹12,500', image: '/cloned_media/bhutan.webp' }
  ]
};
      ...
      <main className="max-w-screen-xl mx-auto px-4 pt-4 sm:pt-8 pb-20 lg:pb-8">
        <div className="lg:hidden mb-4">
           <div className="overflow-x-auto snap-x snap-mandatory flex gap-2">
                {tripData.mobileGallery.map((img, i) => (
                    <img key={i} src={img} className="snap-center flex-shrink-0 w-full h-64 object-cover rounded-lg shadow-md" alt={`Mcleodganj Triund scenery ${i+1}`} />
                ))}
           </div>
        </div>
        ...
        <header className="hidden lg:block mb-6">
          <div className="flex gap-2 h-[500px]">
            <div className="w-3/5">
              <img src={tripData.mainImageDesktop} className="w-full h-full object-cover rounded-l-2xl shadow-lg" alt="Main Mcleodganj Triund view"/>
            </div>
...
export default McleodganjTriund;