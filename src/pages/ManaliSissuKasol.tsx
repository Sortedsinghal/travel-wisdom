...
const tripData = {
  title: 'Manali Sissu Kasol Weekend Trip',
  duration: '4 Days 3 Nights',
  pickupDrop: 'Delhi-Delhi',
  category: 'Weekend Trips',
  pricing: {
    startPrice: '10,500',
    originalPriceQuad: '12,000',
    originalPriceTriple: '11,500',
    originalPriceDouble: '11,000',
    discount: '1,500',
    quad: '10,500',
    triple: '11,000',
    double: '11,500',
  ...
  features: [
    ...
    { name: 'Sightseeing', icon: '/cloned_media/11999820241021130308.png' },
    { name: 'Photography', icon: '/assets/photography.png' },
  ],
  overview: `<p>Experience the perfect blend of mountain beauty and hippie culture in this extended weekend trip covering Manali, Sissu, and Kasol. Journey through the famous Atal Tunnel to reach the stunning Lahaul Valley, explore the serene Sissu village, and immerse yourself in the vibrant cafe culture of Kasol in Parvati Valley. This trip offers breathtaking landscapes, cultural experiences, and the perfect escape from city life.</p>`,
  itinerary: [
    { day: "Day 0", title: "Delhi to Manali | Overnight Journey", content: "<ul><li>Assemble at boarding point in Delhi and meet your Trip Captain.</li><li>Start overnight journey to Manali in comfortable AC bus.</li><li>Socialize with fellow travelers and get excited for the adventure ahead.</li></ul>" },
    { day: "Day 1", title: "Manali Arrival | Local Exploration", content: "<ul><li>Arrive in Manali early morning and check into hotel.</li><li>Freshen up and have breakfast.</li><li>Visit Hadimba Devi Temple surrounded by beautiful deodar trees.</li><li>Explore Old Manali and enjoy cafe hopping.</li><li>Evening visit to Mall Road for shopping and local food.</li><li>Overnight stay in Manali hotel.</li></ul>" },
    { day: "Day 2", title: "Manali to Sissu via Atal Tunnel | Return to Manali", content: "<ul><li>Early morning departure to Sissu via the famous Atal Tunnel.</li><li>Experience the dramatic landscape change from Kullu to Lahaul Valley.</li><li>Visit Sissu village and Sissu Lake (weather permitting).</li><li>Enjoy photography and soak in the mountain views.</li><li>Return to Manali via Solang Valley.</li><li>Optional adventure activities at Solang Valley.</li><li>Overnight stay in Manali.</li></ul>" },
    { day: "Day 3", title: "Manali to Kasol | Kasol Exploration", content: "<ul><li>Check out from Manali hotel after breakfast.</li><li>Drive to Kasol via scenic Parvati Valley.</li><li>Check into hotel/campsite in Kasol.</li><li>Explore the streets of Kasol and visit Chalal bridge.</li><li>Experience the hippie culture and cafe hopping.</li><li>Enjoy riverside relaxation along Parvati River.</li><li>Overnight stay in Kasol.</li></ul>" },
    { day: "Day 4", title: "Kasol to Delhi | Departure", content: "<ul><li>Check out from hotel after breakfast.</li><li>Last-minute exploration and shopping in Kasol.</li><li>Depart for Delhi in the afternoon.</li><li>Overnight journey back to Delhi.</li></ul>" },
    { day: "Day 5", title: "Delhi Arrival", content: "<ul><li>Arrive in Delhi early morning with wonderful memories.</li></ul>" }
  ],
  inclusions: `<ul><li>Transportation: AC Semi-Sleeper bus Delhi to Delhi</li><li>3 Nights accommodation on sharing basis (2 nights Manali + 1 night Kasol)</li><li>6 Meals: 3 Breakfasts + 3 Dinners</li><li>All transfers and sightseeing by tempo traveler</li><li>Experienced Trip Captain</li><li>Driver allowances, toll taxes, parking charges</li></ul>`,
  exclusions: `<ul><li>Any meals not mentioned in inclusions</li><li>Personal expenses and shopping</li><li>Adventure activities at Solang Valley</li><li>Travel insurance</li><li>Any entry fees not mentioned</li><li>GST (5%) applicable extra</li></ul>`,
  thingsToPack: [
    { text: "Good quality backpack and day bag for excursions", icon: '/cloned_media/5261020250821080750.png' },
    { text: "Comfortable walking shoes with good grip", icon: '/cloned_media/7672820250825123523.png' },
    { text: "Warm clothing including jacket, sweaters, and thermals", icon: '/cloned_media/9170920250825123607.png' },
    { text: "Sunscreen, sunglasses, and personal care items", icon: '/cloned_media/14435720250825123645.png' },
    { text: "Personal medications and basic first aid", icon: '/cloned_media/11222620250825123717.png' },
    { text: "Valid ID proofs and travel documents", icon: '/cloned_media/528220250825123752.png' },
    { text: "Camera, power bank, and reusable water bottle", icon: '/cloned_media/7654520250825123857.png' }
  ],
  reviews: [
      { name: "Priya Sharma", rating: 5, comment: "Amazing trip covering three beautiful destinations! The Atal Tunnel experience was incredible and Kasol's vibe was so relaxing. Perfect weekend getaway.", image: '/cloned_media/profilepic.png' },
      { name: "Rohit Kumar", rating: 5, comment: "Well organized trip with great accommodations. Loved the contrast between Sissu's mountains and Kasol's hippie culture. Highly recommend!", image: '/cloned_media/24894620230801111526.png' },
      { name: "Sneha Patel", rating: 4, comment: "Beautiful landscapes and good organization. The combination of Manali, Sissu, and Kasol made it a complete mountain experience.", image: '/cloned_media/159420230801111701.png' }
  ],
  relatedTrips: [
      { title: 'Chopta Tungnath', price: '₹6,500', image: '/cloned_media/himachal.webp' },
      { title: 'Manali Sissu', price: '₹8,500', image: '/cloned_media/uttarakhand.webp' },
      { title: 'Himachal Backpacking', price: '₹12,500', image: '/cloned_media/kashmir.webp' },
      { title: 'Spiti Valley', price: '₹15,000', image: '/cloned_media/bhutan.webp' }
  ]
};
      ...
      <main className="max-w-screen-xl mx-auto px-4 pt-4 sm:pt-8 pb-20 lg:pb-8">
        <div className="lg:hidden mb-4">
           <div className="overflow-x-auto snap-x snap-mandatory flex gap-2">
                {tripData.mobileGallery.map((img, i) => (
                    <img key={i} src={img} className="snap-center flex-shrink-0 w-full h-64 object-cover rounded-lg shadow-md" alt={`Manali Sissu Kasol scenery ${i+1}`} />
                ))}
           </div>
        </div>
        ...
        <header className="hidden lg:block mb-6">
          <div className="flex gap-2 h-[500px]">
            <div className="w-3/5">
              <img src={tripData.mainImageDesktop} className="w-full h-full object-cover rounded-l-2xl shadow-lg" alt="Main Manali Sissu Kasol view"/>
            </div>
...
export default ManaliSissuKasol;