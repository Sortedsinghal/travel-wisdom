...
const tripData = {
  title: 'Kasol Kheerganga Trek Weekend Trip',
  duration: '3 Days 2 Nights',
  pickupDrop: 'Delhi-Delhi',
  category: 'Weekend Trips',
  pricing: {
    startPrice: '8,000',
    originalPriceQuad: '9,500',
    originalPriceTriple: '9,000',
    originalPriceDouble: '8,500',
    discount: '1,500',
    quad: '8,000',
    triple: '8,500',
    double: '9,000',
  ...
  overview: `<p>Experience the perfect blend of hippie culture and mountain adventure with this exciting weekend trip to Kasol and Kheerganga. Known as the "Amsterdam of India," Kasol offers a unique cultural experience with its Israeli cafes and laid-back atmosphere. The highlight of the trip is the trek to Kheerganga, famous for its natural hot springs at 2,960 meters altitude. This trek through dense forests, alongside the Parvati River, offers stunning mountain views and an unforgettable camping experience under the stars.</p>`,
  itinerary: [
    { day: "Day 0", title: "Delhi to Kasol | Overnight Journey", content: "<ul><li>Assemble at boarding point in Delhi and meet your Trip Captain.</li><li>Start overnight journey to Kasol in comfortable AC bus.</li><li>Enjoy the scenic drive through the mountains.</li></ul>" },
    { day: "Day 1", title: "Kasol Arrival | Local Exploration", content: "<ul><li>Arrive in Kasol early morning and check into hotel/campsite.</li><li>Freshen up and have breakfast at a local Israeli cafe.</li><li>Explore the streets of Kasol and visit Chalal village.</li><li>Experience the hippie culture and cafe hopping.</li><li>Evening riverside walk along Parvati River.</li><li>Overnight stay in Kasol.</li></ul>" },
    { day: "Day 2", title: "Kheerganga Trek | Hot Springs Experience", content: "<ul><li>Early morning start for Kheerganga trek from Barshaini.</li><li>Trek through dense forests and scenic landscapes (12 km).</li><li>Reach Kheerganga and set up camps.</li><li>Relax in natural hot springs with mountain views.</li><li>Evening bonfire and stargazing session.</li><li>Overnight camping at Kheerganga.</li></ul>" },
    { day: "Day 3", title: "Kheerganga to Delhi | Departure", content: "<ul><li>Wake up to beautiful sunrise views.</li><li>Trek back to Barshaini after breakfast.</li><li>Drive back to Kasol for lunch and rest.</li><li>Start return journey to Delhi in the evening.</li><li>Overnight journey back to Delhi.</li></ul>" },
    { day: "Day 4", title: "Delhi Arrival", content: "<ul><li>Arrive in Delhi early morning with wonderful memories.</li></ul>" }
  ],
  inclusions: `<ul><li>Transportation: AC Semi-Sleeper bus Delhi to Delhi</li><li>2 Nights accommodation (1 night Kasol + 1 night Kheerganga camping)</li><li>4 Meals: 2 Breakfasts + 2 Dinners</li><li>All transfers and sightseeing by tempo traveler</li><li>Experienced Trek Guide and Trip Captain</li><li>Camping equipment and tents at Kheerganga</li><li>Driver allowances, toll taxes, parking charges</li></ul>`,
  exclusions: `<ul><li>Any meals not mentioned in inclusions</li><li>Personal expenses and shopping</li><li>Hot springs entry fees</li><li>Travel insurance</li><li>Any entry fees not mentioned</li><li>GST (5%) applicable extra</li></ul>`,
  thingsToPack: [
  ...
  reviews: [
      { name: "Priya Sharma", rating: 5, comment: "Amazing trek experience! The hot springs at Kheerganga were absolutely rejuvenating. Kasol's cafe culture was a perfect start to the adventure.", image: '/cloned_media/profilepic.png' },
      { name: "Rohit Kumar", rating: 5, comment: "Perfect weekend getaway for trekking enthusiasts. The trek was challenging but rewarding. Camping under stars at Kheerganga was magical.", image: '/cloned_media/24894620230801111526.png' },
      { name: "Sneha Patel", rating: 4, comment: "Great organization and beautiful trek. The natural hot springs were the highlight. Loved the hippie vibe of Kasol too.", image: '/cloned_media/159420230801111701.png' }
  ],
  relatedTrips: [
      ...
      { title: 'Manali Sissu', price: '₹8,500', image: '/cloned_media/kashmir.webp' },
      ...
      <main className="max-w-screen-xl mx-auto px-4 pt-4 sm:pt-8 pb-20 lg:pb-8">
        <div className="lg:hidden mb-4">
           <div className="overflow-x-auto snap-x snap-mandatory flex gap-2">
                {tripData.mobileGallery.map((img, i) => (
                    <img key={i} src={img} className="snap-center flex-shrink-0 w-full h-64 object-cover rounded-lg shadow-md" alt={`Kasol Kheerganga scenery ${i+1}`} />
                ))}
           </div>
        </div>
        ...
        <header className="hidden lg:block mb-6">
          <div className="flex gap-2 h-[500px]">
            <div className="w-3/5">
              <img src={tripData.mainImageDesktop} className="w-full h-full object-cover rounded-l-2xl shadow-lg" alt="Main Kasol Kheerganga view"/>
            </div>
...
export default KasolKheerganga;