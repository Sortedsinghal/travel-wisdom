...
const handpickedTripsVietnam = allTrips.filter(trip =>
  trip.destination === 'Vietnam' &&
  [
    'vietnam-backpacking',
    'vietnam-trip-with-flights',
    'vietnam-signature-10d9n',
    'vietnam-explorer-8d7n'
  ].includes(trip.slug)
);

const leisureTripsVietnam = allTrips.filter(trip =>
  trip.destination === 'Vietnam' &&
  [
    'unforgettable-vietnam-odyssey',
    'enchanting-escape-to-vietnam',
    'vietnam-danang-ho-chi-minh-6d5n',
    'vietnam-danang-hanoi-6d5n',
    'vietnam-9n10d',
    'vietnam-north',
    'ho-chi-minh-hanoi-6d5n'
  ].includes(trip.slug)
);

const honeymoonTripsVietnam = allTrips.filter(trip =>
  trip.destination === 'Vietnam' &&
  [
    'gems-of-vietnam-couple-exclusive',
    'romantic-vietnam-vacation',
    'vietnam-explorer-honeymoon-edition',
    'vietnam-honeymoon-trip-hanoi-da-nang',
    'southern-vietnam-honeymoon-special',
    'northern-vietnam-honeymoon-special',
    'vietnam-signature-10d9n' // Note: Also in handpicked
  ].includes(trip.slug)
);

const groupTripsVietnam = allTrips.filter(trip =>
  trip.destination === 'Vietnam' &&
  [
    'vietnam-backpacking', // Note: Also in handpicked
    'vietnam-trip-with-flights', // Note: Also in handpicked
    'vietnam-explorer-8d7n' // Note: Also in handpicked
  ].includes(trip.slug)
);

const startHoChiMinhTripsVietnam = allTrips.filter(trip =>
  trip.destination === 'Vietnam' &&
  [
    'vietnam-backpacking', // Note: Also in handpicked & group
    'vietnam-signature-10d9n', // Note: Also in handpicked & honeymoon
    'vietnam-explorer-8d7n', // Note: Also in handpicked & group
    'vietnam-danang-ho-chi-minh-6d5n', // Note: Also in leisure
    'vietnam-9n10d', // Note: Also in leisure
    'ho-chi-minh-hanoi-6d5n', // Note: Also in leisure
    'vietnam-explorer-honeymoon-edition', // Note: Also in honeymoon
    'southern-vietnam-honeymoon-special' // Note: Also in honeymoon
  ].includes(trip.slug)
);
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="space-y-20 mt-20">
            ...
            <section>
              ...
              <div className="hidden md:block">
                <TripSlider trips={groupTripsVietnam} slidesToShow={4} />
              </div>
              <div className="md:hidden">
